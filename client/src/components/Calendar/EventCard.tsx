...
export default function EventCard({ performance }: Performance) {
  ...
  const verTwo = (
    <div className="card 
                    rounded-2xl
                    justify-center 
                    bg-no-repeat bg-cover bg-center bg-local
                    w-full
                    h-28
                    overflow-hidden
                    shadow-2xl"
      style={{ backgroundImage: `url(${performance.tp_poster_image_default_url})` }}
    >
      ...
      >
        <div className="left-side
                        ...
                        place-content-start
                        p-2 
                        bg-cover bg-center bg-local bg-no-repeat
                        "
          style={{ backgroundImage: `url(${performance.tp_poster_image_default_url})` }}
        >
        </div>
        ...
        >
          ...
          '>
            <img className="logo
              max-h-12
              aspect-square rounded-full object-cover" alt="logo" src={performance.tp_org_logo_image_default_url} />
            <button
              type='button'
              ...
              <div className="relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg">
                ...
                '>
                  <div className="
                      ...
                      rounded-full
                      bg-cover"
                    style={{ backgroundImage: `url(${performance.tp_org_logo_image_default_url})` }}
                  ></div>
                  <div className='flex 
                      items-center justify-center 
                  '>
                ...
                <div className="mt-2 text-center sm:ml-4 sm:text-left">
                  ...
                  <img className='
                      h-auto w-full
                      aspect-square rounded-md object-cover' alt="event poster"
                  ...
                  <div className="buttons-block
                    items-center gap-2 mt-3 sm:flex">
                    <button
