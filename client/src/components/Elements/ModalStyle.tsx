    ...
    <>
      {
        <div id="defaultModal" tabIndex={-1} aria-hidden="true"
          ...
          <div className="relative max-w-3xl w-full max-h-screen m-[1.5rem] rounded-lg overflow-hidden">
            ...
            {/* <!-- Modal content --> */}
            <div className="relative bg-white flex flex-col justify-between shadow w-full max-h-[calc(100vh-2.5rem)] overflow-hidden">

              {/* <!-- Modal header --> */}
              <div className="flex items-start justify-between py-2 px-2 border-b">
