...
function Header() {
  ...
  function handleNameClick() {
    const names = ["Киоск комедии", "Кусок комедии", "Коморка комедии", "Стендап алиэкспресс", "Кукла колдуна", "Не оценивайте, расслабьтесь", "Себе потыкай", "Я логотип", "Ай", "Damage is done", "Кусок комеди", "Кисок комедии", "Бывало такое"];
