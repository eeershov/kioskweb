  ...
  return (
    <footer className='mx-auto w-full p-4 py-3'>
      ...
      <div className="flex items-center flex-wrap justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400 mb-1">{new Date().getFullYear()} <a href="https://kioskcomedy.org/" className="hover:underline">kioskcomedy.org</a>
        </span>
